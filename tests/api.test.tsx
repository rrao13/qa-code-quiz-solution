...
app.post('/user', (req, res) => {
    ...
    fs.writeFileSync('./storage/account.json', JSON.stringify(data), 'utf-8', res.send("Account Created"));
})
...
app.delete('/user', (req, res) => {
    ...
    console.log(data);
    fs.writeFileSync('./storage/account.json', JSON.stringify(data), 'utf-8', res.send("Account Deleted"));
})
...
app.put('/user', (req, res) => {
    ...
    fs.writeFileSync('./storage/account.json', JSON.stringify(data), 'utf-8', res.send("Account Updated"));
})
